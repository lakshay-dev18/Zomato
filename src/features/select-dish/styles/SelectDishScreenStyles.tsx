...
const styles = StyleSheet.create({           
    ...
    plantText:{ fontFamily: 'Segoe UI', fontWeight: 400, fontSize: 16, letterSpacing: 0, marginLeft:10 },
    iconContainer:{ flexDirection:'row', marginTop:5, marginLeft:10, gap:10 },
    ...
    vegText:{ fontFamily: 'Segoe UI', fontWeight: 400, fontSize: 11, letterSpacing: 0, marginLeft:10, marginTop:2 },
    ...
    addText:{ fontFamily: 'Segoe UI', fontWeight: 400, fontSize: 14, letterSpacing: 0, marginLeft:10 },
    selectionText:{ fontFamily: 'Segoe UI', fontWeight: 400, fontSize: 12, letterSpacing: 0, marginLeft:10 },
    ...
    priceText:{ },
    priceContainer:{ flexDirection:'row', gap:15 },
