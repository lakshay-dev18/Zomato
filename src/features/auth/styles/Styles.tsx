...
const styles = StyleSheet.create({
    ...
    fbButton:{ backgroundColor:Color.button, width: '48%', height: 59, opacity: 1, borderRadius: 8, marginBottom: 16, flexDirection:'row',  },
    fbButtonText:{ fontFamily: 'Segoe UI', fontSize: 18, lineHeight: 24, letterSpacing: 0, paddingLeft:10 },
    googleButton:{ width: '48%', height: 59, opacity: 1, borderRadius: 8, backgroundColor:Color.button, marginBottom: 16, flexDirection:'row' },
    ...
    buttonContainer:{ flexDirection: "row", marginBottom: 16, gap:11 },
